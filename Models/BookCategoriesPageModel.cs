...
namespace Calalb_Ana_Lab8.Models
{
    public class BookCategoriesPageModel:PageModel
    {
        ...
        public void PopulateAssignedCategoryData(Calalb_Ana_Lab8Context context,Book book)
        {
        ...
        public void UpdateBookCategories(Calalb_Ana_Lab8Context context,string[] selectedCategories,Book bookToUpdate)
        {
